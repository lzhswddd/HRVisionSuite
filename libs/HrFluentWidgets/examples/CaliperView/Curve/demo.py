...
from hrfluentwidgets import(
    ...
    CaliperCurveItemSupport, CaliperCurveItemData, CaliperCurveItemConfigItem, GraphicsCaliperCurveItem,
)
...
if __name__ == "__main__":
    ...
    param_cfg.addParam(CaliperCurveItemConfigItem("measure", "calipers", CaliperCurveItemData()))
    ...
    paramWidget.addItemType("rotated_caliper_rect", lambda : GraphicsCaliperCurveItem(), CaliperCurveItemSupport())
