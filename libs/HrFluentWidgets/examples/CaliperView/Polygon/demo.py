...
from hrfluentwidgets import(
    ...
    GraphicsCaliperRectParam, GraphicsCrossItem,
    PolygonCaliperItemSupport, CaliperPolygonItemData, CaliperPolygonItemConfigItem, GraphicsCaliperPolygonItem,
)
...
if __name__ == "__main__":
    ...
    param_cfg.addParam(CaliperPolygonItemConfigItem("measure", "calipers", CaliperPolygonItemData()))
    ...
    paramWidget.addItemType("rotated_caliper_rect", lambda : GraphicsCaliperPolygonItem(is_closed=False), PolygonCaliperItemSupport())
    ...
    image = QImage(r"C:\Users\lzh\Desktop\Image_20250702183033892.bmp")
    ...
    def test(key:str,img:QImage):
        if key == "measure.calipers":
            ...
            if isinstance(calipers, dict):
                ...
                measure.clear()
                for caliper_key, line in calipers.items():
